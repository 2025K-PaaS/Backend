...
from sqlalchemy import (
    Column, Integer, String, ForeignKey, DateTime, func, UniqueConstraint, Index
)
...
class PointLedger(Base):
    ...
    delta = Column(Integer, nullable=False)                     # 변화량 (+/-)
    reason = Column(String(50), nullable=False)                 # 'deal_reward', 'admin_grant', ...
    ref_type = Column(String(50), nullable=True)                # 연결 엔티티 타입(e.g., 'deal')
    ref_id = Column(String(100), nullable=True)                 # 연결 엔티티 ID
